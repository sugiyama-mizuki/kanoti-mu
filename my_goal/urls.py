...
urlpatterns = [
    ...
    path('my_goal-delete/<int:pk>',views.My_GoalDeleteView.as_view(), name="goal_delete"),
    path('my_goal-detail/<int:pk>',views.My_GoalDetailView.as_view(), name="goal_detail"),
